...
## Learning Objectives
- Understand how to replicate a random quote generator application which is a simple app that displays different quotes. it supports a good user interface and interesting user experience.

## Description of the Project
For the first milestone in the process of creating Random quote generator, you will:
